        ...
        <div class="clud-page">
            <div class="page-content" :class="{ 'mobile-ui': isMobileWindow }">
                <div class="club-list-wrap">
                    ...
                    <div class="major-selecter neu-morphism-card none-dragging">
                        <transition name="current-major-ani">
                            <div
                                ...
                                :class="{ [division]: true }"
                            >
                                <span v-if="division === 'security'"
                                    >정보보호과</span
                                >
                                <span v-else-if="division === 'software'"
                                    >소프트웨어과</span
                                >
                                <span v-else-if="division === 'buisness'"
                                    >IT경영과</span
                                >
                                <span v-else-if="division === 'design'"
                                    >콘텐츠 디자인과</span
                                >
                                <span v-else-if="division === 'general'"
                                    >일반 동아리</span
                                >
                                <span v-else-if="division === 'autonomous'"
                                    >자율 동아리</span
                                >
                            </div>
                        </transition>
                        ...
                        <transition name="choice-major-ani">
                            <div
                                class="choice-major-wrap none-dragging"
                                v-if="isShowDivisions"
                                @click="isShowDivisions = false"
                            >
                                <div
                    ...
                    <ul
                        v-if="loadedClubData"
                        class="club-list neu-morphism-card none-dragging"
                    >
                        <li
                            v-for="(i, n) in loadedClubData"
                            :key="n"
                        ...
                        >
                            ...
                            <div v-if="!isMobileWindow" class="club-name">
                                {{ i.name }}
                            </div>
                        </li>
                    </ul>
